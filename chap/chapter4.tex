...
%     \includegraphics[width=1.0\linewidth]{images/ticket_cum_high_price_ver1.pdf}
...
\begin{figure*}[!t]
  ...
  \begin{minipage}[b]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/ticket_cum_syotai_price_ver1.pdf}
    \subcaption{図1の説明}
    \label{fig:1}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/ticket_cum_yutai_price_ver1.pdf}
    \subcaption{図2の説明}
    \label{fig:2}
  \end{minipage}
  ...
  \begin{minipage}[b]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/ticket_cum_low_price_ver1.pdf}
    \subcaption{図3の説明}
    \label{fig:3}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/ticket_cum_middle_price_ver1.pdf}
    \subcaption{図4の説明}
    \label{fig:4}
  \end{minipage}
  ...
  \begin{minipage}[b]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/ticket_cum_high_price_ver1.pdf}
    \subcaption{図5の説明}
    \label{fig:5}
  \end{minipage}
  \hfill
  ...
  \caption{2列で5枚の図を並べた例}
  \label{fig:five_2cols}
\end{figure*}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Temporal_changes_in_the_latent_space_ver3.pdf}
